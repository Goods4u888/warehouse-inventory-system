...
const I18N = {
  en: {
    ...
    requestFormIntro: "Search for an item and say how many, add a comment, or both — you'll get a request number to reference with the warehouse team.",
    fieldRequesterName2: 'Your name',
    fieldDepartment: 'Department',
    fieldSelectItem: 'Item (optional)',
    searchItemsPlaceholder: 'Search items by name or code',
    btnChangeItem: 'Change',
    fieldQtyNeeded: 'Quantity',
    fieldComment: 'Additional comments',
    fieldCommentPh: 'Anything else the warehouse team should know…',
    fieldCommentHint: "Required if you didn't select an item above.",
    emptySearchResultsShort: 'No matching items',
    errorQtyRequired: 'Please enter a quantity for the selected item',
    errorItemOrComment: 'Please select an item or add a comment',
  ...
  th: {
    ...
    requestFormIntro: 'ค้นหารายการสินค้าและระบุจำนวน เพิ่มความคิดเห็น หรือทั้งสองอย่าง — คุณจะได้รับหมายเลขคำขอสำหรับอ้างอิงกับทีมคลังวัสดุ',
    fieldRequesterName2: 'ชื่อของคุณ',
    fieldDepartment: 'แผนก',
    fieldSelectItem: 'รายการสินค้า (ไม่บังคับ)',
    searchItemsPlaceholder: 'ค้นหาสินค้าด้วยชื่อหรือรหัส',
    btnChangeItem: 'เปลี่ยน',
    fieldQtyNeeded: 'จำนวน',
    fieldComment: 'ความคิดเห็นเพิ่มเติม',
    fieldCommentPh: 'สิ่งอื่นที่ทีมคลังวัสดุควรทราบ…',
    fieldCommentHint: 'จำเป็นหากคุณไม่ได้เลือกรายการสินค้าด้านบน',
    emptySearchResultsShort: 'ไม่พบรายการที่ตรงกัน',
    errorQtyRequired: 'กรุณาระบุจำนวนสำหรับรายการที่เลือก',
    errorItemOrComment: 'กรุณาเลือกรายการสินค้าหรือเพิ่มความคิดเห็น',
